...
export const getDeals = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).send({ type: "deals", data: deals });
  } catch (error) {
...
export const getDeal = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).send({ type: "deal", data: deal });
  } catch (error) {
    res.status(400).send({ type: "error", error });
  }
};
...
export const createDeal = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).send({ type: "deal", data: newDeal });
  } catch (error) {
    res.status(400).send({ type: "error", error });
  }
};
...
export const updateDeal = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).send({ type: "deal", data: updatedDeal });
  } catch (error) {
    res.status(400).send({ type: "error", error });
  }
};
...
export const deleteDeal = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).send({ type: "deal", data: "deal deleted" });
  } catch (error) {
    res.status(400).send({ type: "error", error });
  }
};
